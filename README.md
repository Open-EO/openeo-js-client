...
* [Documentation](https://open-eo.github.io/openeo-js-client/1.2.0/).

The version of this client is **1.2.0** and supports **openEO API versions 1.x.x**.
...
More information can be found in the [documentation](https://open-eo.github.io/openeo-js-client/1.2.0/).
