...
class OgcCapabilities extends Capabilities {
	...
	constructor(data) {
		...
		Object.assign(this.featureMap, {
			...
			describeCollectionSchema: 'get /collections/{}/schema',
			// Sync Processing
		...
		const isCoverage = this.hasConformance('http://www.opengis.net/spec/ogcapi-coverages-1/1.0/conf/core');
		if (isCoverage) {
			this.features.push('get /collections/{}/coverage');
			this.features.push('get /collections/{}/schema');
		}
