...
declare module OpenEO {
    /**
     * The base export class for authentication providers such as Basic and OpenID Connect.
     *
     * @abstract
     */
    ...
    /**
     * The base export class for entities such as Job, Process Graph, Service etc.
     *
     * @abstract
     */
     ...
     * In this case you must provide a function that creates your new export class to the
    ...
    /**
     * Main export class to start with openEO. Allows to connect to a server.
     *
     * @hideconstructor
     */
    export class OpenEO {
    ...
    /**
     * A export class to construct processes easily.
     *
    ...
    export class Builder {
         ...
         *
         * See the {@link Formula} export class for more information.
         *
    ...
    /**
     * A export class that represents a process node and also a result from a process.
     */
    export class BuilderNode {
         ...
         */
        constructor(parent: any, processId: string, processArgs?: any, processDescription?: string | null);
    ...
    /**
     * A export class that represents a process parameter.
     *
    ...
    export class Parameter {
         ...
         * so that array access is possible (see export class description).
         *
         * @static
